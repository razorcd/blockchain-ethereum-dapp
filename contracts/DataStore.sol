...
contract DataStore {
    ...
    address ReceivingAccount = 0x627306090abaB3A6e1400e9345bC60c78a8BEf57;  //read from properties file
    ...
    function Oursurance() payable public {
        creator = msg.sender;
        LogFundsReceived(msg.sender, msg.value);
    }
     ...
     */
    function AddNewData(uint Id, string Name, string Secret) public payable returns(bool sufficient) {
        Data memory newData;
        newData.Id = Id;
        newData.Name = Name;
